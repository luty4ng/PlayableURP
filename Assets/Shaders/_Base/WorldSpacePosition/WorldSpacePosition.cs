...
public class WorldSpacePosition : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    public class ReconstructPass : ScriptableRenderPass
    {
        public Material material;
    ...
    private ReconstructPass m_ReconstructPass;
    public ReconstructPass GetPass()
    {
        return m_ReconstructPass;
    }

    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        m_ReconstructPass.SetSourceId(renderer.cameraColorTarget);
        renderer.EnqueuePass(m_ReconstructPass);
    }

    public override void Create()
    {
        m_ReconstructPass = new ReconstructPass();
        m_ReconstructPass.material = setting.material;
        m_ReconstructPass.renderPassEvent = setting.renderPassEvent;
    }
}